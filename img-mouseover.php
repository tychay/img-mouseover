...
Version:      1.0
Description:  Allows you to have img mouseovers on the page without resorting to javascript. Just class="mouseover" oversrc="URL_TO_MOUSEOVER" noresize="true" (the last one to not change dimensions)
Author:       tychay
